...
public class PetSteps {
    ...
    // creating the pet with give name and status
    ...
    // creating the pet with given name,category,status
    ...
    // verifying whether the pet is created successfully or not
    @Then("the pet should be created successfully")
    public void verifyCreated() {
        Response r = (Response) ctx.get("lastResponse");
        AssertUtils.assertResponseType(r.getStatusCode(), "successful");
    }
    // fetching the created pet
    ...
    // fetching pets with required status
